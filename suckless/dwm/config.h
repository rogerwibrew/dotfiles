...
static const int refreshrate        = 60;       /* refresh rate for drawbar */
...
/* Using rofi instead of dmenu for better application launcher (fuzzy search, only shows .desktop apps) */
